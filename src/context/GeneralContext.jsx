...
const GeneralContextProvider = ({ children }) => {
  ...
  const fetchTopNews = async () => {
    try {
      const response = await axios.get(
        "https://newsapi.org/v2/everything?q=popular&apiKey=cca31768b1bd47a5b69a75846e3dca84"
      );
  ...
  const fetchBusinessNews = async () => {
    try {
      const response = await axios.get(
        "https://newsapi.org/v2/everything?q=business&apiKey=cca31768b1bd47a5b69a75846e3dca84"
      );
